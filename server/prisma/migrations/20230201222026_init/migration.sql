...
ALTER TABLE "cartProducts"
    ADD CONSTRAINT "cartProducts_cartId_fkey" FOREIGN KEY ("cartId") REFERENCES "carts" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "productSubcategories"
    ADD CONSTRAINT "productSubcategories_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "productCategories" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products"
    ADD CONSTRAINT "products_subcategoryId_fkey" FOREIGN KEY ("subcategoryId") REFERENCES "productSubcategories" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
